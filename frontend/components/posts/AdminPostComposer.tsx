...
export function AdminPostComposer({
  ...
  return (
    <>
      <DrawerSheet visible={visible} title="Đăng bài" onClose={close} full>
        <View style={postComposerStyles.composerScreen}>
          ...
          <View style={postComposerStyles.composerFooter}>
            <Pressable
              style={postComposerStyles.composerCancelButton}
              onPress={close}
              disabled={saving}
            >
              <Text style={postComposerStyles.composerCancelText}>Hủy</Text>
            </Pressable>
            <View style={{ flex: 1 }}>
              <PrimaryButton
                label="Lưu bài đăng"
