...
> = {
  plots: [
    ...
    },
    {
      ...
      label: "Tên luống",
      required: true,
      aliases: ["name", "tên", "tenluong", "tên luống", "label", "plot_name"],
    },
    {
      key: "envMode",
      label: "Môi trường (outdoor / greenhouse)",
      required: true,
      aliases: [
        "env_mode",
        "envmode",
  ...
  diseases: [
    ...
    },
    {
      ...
      label: "Loại bệnh",
      required: true,
      aliases: ["type", "loại", "loại bệnh", "loaibenh", "disease_type"],
    },
    {
      key: "description",
      label: "Ghi chú / Mô tả",
  ...
  accounts: [
    ...
    },
    {
      ...
      label: "Mật khẩu",
      required: true,
      aliases: ["password", "mật khẩu", "matkhau", "pass"],
    },
  ],
};
  ...
  fields.forEach((field) => {
    const matchedHeader = headers.find((h) => {
      ...
      return field.aliases.some((alias) => {
        ...
        return normH === normA || (normA.length >= 3 && normH.includes(normA));
      });
    });
